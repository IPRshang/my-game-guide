...
| Weapon | ATK | Durability | Source |
|--------|:---:|:---:|--------|
| Master Sword | 30/60 | 188 | Pull with 13 hearts; doubles near Gloom |
| Ancient Blade | 40 | 54 | Akkala Ancient Tech Lab |
| Champion's Sword | 36 | 36 | Divine Beast quest reward |
| Savage Lynel Sword | 36 | 36 | White-Maned Lynel drop |

## Two-Handed Weapons

| Weapon | ATK | Source |
|--------|:---:|--------|
| Royal Guard's Claymore | 72 | Hyrule Castle |
| Ancient Bladesaw | 55 | Ancient Tech Lab |
...
| Weapon | ATK | Trait |
|--------|:---:|-------|
| Royal Guard's Spear | 62 | High ATK, low durability |
| Lightscale Trident | 22 | Mipha's weapon, repairable |
| Savage Lynel Spear | 30 | Lynel drop |

## Bows

| Bow | ATK | Trait |
|-----|:---:|-------|
| Ancient Bow | 44 | Longest range |
...
### Master Sword (One of a Kind)
- **Base ATK**: 30
- **Near Gloom / Dungeons**: 60 (glowing state)
- **Durability**: 188 (10-minute recharge when depleted)
- **Beam Attack**: Throw (R) at full health to fire sword beams

### One-Hit Obliterator
- Instantly kills any enemy
- But leaves you with only a quarter heart
- One of the DLC final rewards

## Weapon Durability Management

| Trick | Description |
|-------|-------------|
| Menu Overload | Duplicate weapons via menu glitch |

...
- title: 免费开放
  details: 所有攻略完全免费，网站无付费墙，支持广告维持运营。
...
<div class="game-card" style="background: linear-gradient(135deg, #1a1a2e, #16213e); color: #fff;">
  <h3>🔥 GTA6 — 侠盗猎车手 VI</h3>
  <p>罪恶都市归来，最全攻略助你称霸迈阿密街头</p>
  <table style="margin: 0.5rem 0; background: rgba(255,255,255,0.05); box-shadow: none;">
    <tr><td style="border-color: rgba(255,255,255,0.1);">发售</td><td style="border-color: rgba(255,255,255,0.1);">2025 年秋</td></tr>
    <tr><td style="border-color: rgba(255,255,255,0.1);">平台</td><td style="border-color: rgba(255,255,255,0.1);">PS5 / Xbox Series X|S</td></tr>
    <tr><td style="border-color: rgba(255,255,255,0.1);">类型</td><td style="border-color: rgba(255,255,255,0.1);">开放世界 / 动作冒险</td></tr>
  </table>
  <p><a href="/gta6/" style="color: #e74c3c;">→ 进入 GTA6 攻略专区</a></p>
</div>
...
<div class="game-card" style="border-left: 4px solid #8e44ad;">
  ...
  <p><a href="/elden-ring/">→ 进入艾尔登法环攻略专区</a></p>
</div>

<div class="game-card" style="border-left: 4px solid #00d4ff;">
  <h3>🤖 赛博朋克 2077</h3>
  <p>夜之城的传奇，你的选择定义一切</p>
  <table style="margin: 0.5rem 0; box-shadow: none;">
  ...
  <p><a href="/cyberpunk/">→ 进入赛博朋克攻略专区</a></p>
</div>
...
- **[GTA6 快速赚钱指南](/gta6/money-guide)** — 从零到百万富翁的 8 种合法与灰色手段
- **[黑神话悟空 Boss 全攻略](/wukong/boss-guide)** — 81 个 Boss 打法详解
- **[艾尔登法环新手入门](/elden-ring/beginner-guide)** — 30 分钟从入门到精通
- **[赛博朋克 2077 全结局](/cyberpunk/endings)** — 5 种结局触发条件
- **[王国之泪全神庙位置](/zelda/shrines)** — 152 座神庙完整地图
